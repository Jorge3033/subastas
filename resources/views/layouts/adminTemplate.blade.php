      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header"><i class="fas fa-fw fa-table"></i>Control</h6>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/reportAdmins">Admins</a>
            <a class="collapse-item" href="/reportArticles">Articulos</a>
            <a class="collapse-item" href="/reportCategories">Categorias</a>
            <a class="collapse-item" href="/reportPresales">Preventas</a>
            <a class="collapse-item" href="/reportSubCategories">Subcategorias</a>
            <a class="collapse-item" href="/reportUsers">Usuarios</a>
          </div>
        </div>
      </li>
      <!--
